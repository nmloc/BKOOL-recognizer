...
class BKOOLLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            ...
            "NOT", "CONCATENATION", "ASSIGN", "INDEXOP", "LB", "RB", "LP", 
            "RP", "LSB", "RSB", "SEMI", "COLON", "COMMA", "DOT", "INT_LIT", 
    ...
    ruleNames = [ "T__0", "COMMENT_LINE", "COMMENT_BLOCK", "BOOLEAN", "INT", 
                  ...
                  "ASSIGN", "INDEXOP", "LB", "RB", "LP", "RP", "LSB", "RSB", 
                  "SEMI", "COLON", "COMMA", "DOT", "INT_LIT", "FLOAT_LIT", 
